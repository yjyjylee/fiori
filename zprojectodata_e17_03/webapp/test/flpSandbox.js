		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind",
									"targetURL": "#ntzprojectodatae1703-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ntzprojectodatae1703-display": {
								"semanticObject": "ntzprojectodatae1703",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nt.zprojectodatae1703",
									"url": sap.ui.require.toUrl("nt/zprojectodatae1703")
								}
							}
						}
					}
