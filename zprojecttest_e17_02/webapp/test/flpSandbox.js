		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#c05zprojectteste1702-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"c05zprojectteste1702-display": {
								"semanticObject": "c05zprojectteste1702",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=c05.zprojectteste1702",
									"url": sap.ui.require.toUrl("c05/zprojectteste1702")
								}
							}
						}
					}
