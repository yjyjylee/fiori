		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zezoui5r07test-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zezoui5r07test-display": {
								"semanticObject": "zezoui5r07test",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zezoui5r07test",
									"url": sap.ui.require.toUrl("zezoui5r07test")
								}
							}
						}
					}
