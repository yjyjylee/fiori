		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zezoui5c06test-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zezoui5c06test-display": {
								"semanticObject": "zezoui5c06test",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zezoui5c06test",
									"url": sap.ui.require.toUrl("zezoui5c06test")
								}
							}
						}
					}
