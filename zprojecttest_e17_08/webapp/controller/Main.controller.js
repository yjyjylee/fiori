sap.ui.define([
    ...
    function (Controller, JSONModel, FlattenedDataset,FeedItem ) {
        ...
        return Controller.extend("zprojectteste1708.controller.Main", {

            onInit: function () {
                this._setChartInView();
                this._setChartInController(); //ver2
            },
            //ver2 차트 데이터 세팅
            ...
            _setChartInView : function() {
                var oData = {
                    list : [
                        ...
                        {name :'수학', rate : '50', cost : '22'},
                        {name :'영어', rate : '80', cost : '64'},
                        {name :'도덕', rate : '80', cost : '44'},
                        {name :'체육', rate : '70', cost : '33'}

                    ]
                };
                var charUid = this.byId("idViewChart").getVizUid();

                this.getView().setModel(new JSONModel(oData), "view");
                this.byId("idViewPopover").connect(charUid);
            }
        });
    });
